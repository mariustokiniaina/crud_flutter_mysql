...
class _AddDataState extends State<AddData> {
  ...
  void addData() {
    var url = "http://localhost/my_store/adddata.php";
  ...
  void error(BuildContext context, String error) {
    ...
    void showValue(BuildContext context, String value) {
    final scaffold = ScaffoldMessenger.of(context);
    scaffold.showSnackBar(
      SnackBar(
        content: Text(value),
                ...
                Column(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: RaisedButton(
                        onPressed: () {
                          showValue(context, controllerCode.value.text);
                          // debugPrint(controllerCode.value.text);
